        ...
        <div class="flex-sm-column footer-flex flex-lg-row justify-content-center align-content-center flex-sm-wrap">
           ...
           <div class="col-lg-4 justify-content-center text-center pt-lg-5 py-3">
              ...
              <p class="text-white py-lg-5 text-center py-sm-2">
                 Copyright
                 <a class="footer-nosi" href="https://www.nosi.cv" target="_blank">NOSi</a
                    >
                 2024 &#169;
              </p>
           </div>
           <div class="row col-lg-4 d-flex justify-content-center">
              <ul class="row-cols-lg-4 d-inline-flex d-flex pt-lg-5" style="width: 50%">
                 ...
                 <li class="col social-icons">
                    <a href="https://www.facebook.com/nosicv/" target="_blank">
                       <svg width="20" height="20" viewBox="0 0 11 21" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
                          <path d="M10.2792 11.8125L10.8496 8.01199H7.28306V5.54572C7.28306 4.50598 7.78127 3.49248 9.3786 3.49248H11V0.256758C11 0.256758 9.52863 0 8.12184 0C5.18471 0 3.26486 1.82027 3.26486 5.11547V8.01199H0V11.8125H3.26486V21H7.28306V11.8125H10.2792Z" fill="white" />
                       </svg>
                    </a>
                 </li>
                 <li class="col social-icons">
